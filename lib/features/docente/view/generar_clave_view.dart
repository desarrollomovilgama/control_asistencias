...
/// @description: Genera clave de asistencia real desde Laravel.
/// @version: 2.0.0
...
class GenerarClaveView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: const _GenerarClaveBody(),
    );
  }
}

class _GenerarClaveBody extends StatefulWidget {
  const _GenerarClaveBody();

  @override
  State<_GenerarClaveBody> createState() => _GenerarClaveBodyState();
}

class _GenerarClaveBodyState extends State<_GenerarClaveBody> {
      ...
      if (args is Map<String, dynamic>) {
        ...
        if (classroomId != null) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            context.read<ClaveAsistenciaViewModel>()
                .seleccionarGrupo(classroomId);
          });
        }
      }
      _inicializado = true;
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    initialValue: claveVm.classroomId,
