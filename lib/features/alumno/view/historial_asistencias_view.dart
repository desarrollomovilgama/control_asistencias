...
/// @description: Historial de asistencias del alumno con opción de justificante.
/// @version: 2.0.0
...
class _HistorialAsistenciasViewState extends State<HistorialAsistenciasView> {
  ...
  Future<void> _cargar() async {
    ...
    if (result['success'] == true) {
      ...
      setState(() {
        _historial = data.map((e) => RegistroAsistencia.fromJson(e)).toList();
        _cargando = false;
      });
    } else {
      setState(() {
      ...
      body: _cargando
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, i) {
            ...
            final esFalta = r.estado == EstadoAsistencia.falta;
            return InfoCard(
              onTap: esFalta
                  ? () => Navigator.of(context).pushNamed(
                RouteNames.solicitarJustificante,
                arguments: {'faltaId': r.id},
              )
                  : null,
              child: Row(
                children: [
